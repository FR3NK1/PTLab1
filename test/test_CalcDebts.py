...
class TestCalcDebts:
    ...
    def input_data(self) -> tuple[DataType, int]:
        ...
        # Исходя из данных, только Абрамов и
        # Петров имеют задолженности по двум предметам.
        students_with_debts = 2

        return data, students_with_debts

    def test_init_calc_rating(self, input_data: tuple[DataType, int]) -> None:
